# =====================================================================
# SCRIPT NAME: Get-EMPUsersMissingEmployeeID.ps1
# AUTHOR: Kevin Estrada
# DATE: 2026-03-25
# DESCRIPTION:
#   This script performs a read-only audit of Active Directory to identify
#   employee accounts (Description = "EMP") that are missing an employeeID.
#
...
# ===============================
$OutputCsv  = "C:\Reports\EMP_Users_Missing_EmployeeID.csv"
$SearchBase = "OU=Users,DC=yourdomain,DC=com"
$Server     = "your-domain-controller.yourdomain.com"


# ===============================
# GET EMP USERS MISSING EMPLOYEEID
# ===============================
try {
    $Results = Get-ADUser `
        -Server $Server `
        ...
        -Properties Description, employeeID, DistinguishedName, Name `
        -ErrorAction Stop |
